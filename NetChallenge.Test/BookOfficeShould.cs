...
namespace NetChallenge.Test
{
    ...
    {
        public BookOfficeShould(ILocationRepository locationRepository, IOfficeRepository officeRepository, IBookingRepository bookingRepository, IMapper mapper, IResourceRepository resourceRepository, IUserRepository userRepository) : base(locationRepository, officeRepository, bookingRepository, mapper, resourceRepository, userRepository)
        {
        ...
        public void BookAnOffice()
        {
            ...
            Assert.Contains(bookings, x => x.LocationName == request.LocationName &&
                                           ...
                                           x.Duration == request.Duration.ToTimeSpan() &&
        ...
        {
            var date = BookOfficeRequestMother.Default.CheckIn;
