...
namespace NetChallenge.Test
{
    ...
    {
        public GetOfficeSuggestionsShould(ILocationRepository locationRepository, IOfficeRepository officeRepository, IBookingRepository bookingRepository, IMapper mapper, IResourceRepository resourceRepository, IUserRepository userRepository) : base(locationRepository, officeRepository, bookingRepository, mapper, resourceRepository, userRepository)
        {
